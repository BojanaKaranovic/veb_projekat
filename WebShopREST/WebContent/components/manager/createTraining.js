	...
	<section class="h-100 h-custom" style=" margin-top:1.1%;">
					...
					<div class="card rounded-3 ">
			            ...
			            <div class="card-body p-4 p-md-5">
			            	<form class="px-md-2">
			            	 	...
			            	 	<div class="form-outline mb-4">
			            	 		<input v-model="durationInMinutes" type="number" class="form-control" id="inputdurationInMinutes" placeholder="Trajane">
			            	 	</div>
			            	 	<div class="form-outline mb-4">
		...
		create : function(){
            ...
            if(!this.name || !this.type || !logoDestination || !this.coach){
	            ...
	            {"name": this.name, "type": this.type, "sportFacility": '', "durationInMinutes" : this.durationInMinutes, "coach" : '', "description": this.description, "image" : logoDestination, "deleted": false})
	            .then(response => {
	                if(response.data){
